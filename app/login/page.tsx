...
export default function LoginPage() {
  ...
  async function submit(event: FormEvent) { event.preventDefault(); const supabase = createSupabaseBrowserClient(); const { error } = await supabase.auth.signInWithOtp({ email }); setMessage(error?.message ?? "Check your email for a secure sign-in link."); }
